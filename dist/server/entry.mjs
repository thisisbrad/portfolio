...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__$1, { _: "/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/node_modules/.bin/astro" })?.PROD) {
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: "/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/node_modules/.bin/astro" })?.DEV) {
...
const _manifest = deserializeManifest({"rootDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/","cacheDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/node_modules/.astro/","outDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/dist/","srcDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/","publicDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/public/","buildClientDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/dist/client/","buildServerDir":"file:///Users/bbeltowski/Documents/Dev_Box/demos/portfolio/dist/server/","adapterName":"@astrojs/cloudflare","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".page-404[data-astro-cid-zetdm5md]{max-width:860px;margin:0 auto;padding:48px 24px 100px;position:relative;z-index:1}.error-digits[data-astro-cid-zetdm5md]{display:flex;gap:0;margin-bottom:48px}.error-digit[data-astro-cid-zetdm5md]{font-family:Archivo Black,sans-serif;font-size:clamp(6rem,18vw,14rem);line-height:1;padding:0 clamp(12px,3vw,24px);border:4px solid var(--black);box-shadow:8px 8px 0 var(--black);display:inline-flex;align-items:center;justify-content:center;user-select:none}.ed-yellow[data-astro-cid-zetdm5md]{background:var(--yellow);color:var(--black)}.ed-coral[data-astro-cid-zetdm5md]{background:var(--coral);color:var(--white);margin:0 -4px;position:relative;z-index:1}.ed-cyan[data-astro-cid-zetdm5md]{background:var(--cyan);color:var(--black)}.error-body[data-astro-cid-zetdm5md]{margin-bottom:48px}.error-headline[data-astro-cid-zetdm5md]{font-family:Bricolage Grotesque,sans-serif;font-weight:800;font-size:clamp(1.6rem,4vw,2.4rem);letter-spacing:-.03em;color:var(--black);margin-bottom:14px}.error-subtext[data-astro-cid-zetdm5md]{font-family:Space Mono,monospace;font-size:.82rem;line-height:1.7;color:#0d0d0d8c}.icon-row[data-astro-cid-zetdm5md]{display:flex;gap:16px;flex-wrap:wrap;margin-bottom:52px}.icon-link[data-astro-cid-zetdm5md]{display:flex;flex-direction:column;align-items:center;gap:10px;text-decoration:none;padding:18px 16px 14px;border:3px solid var(--black);box-shadow:5px 5px 0 var(--black);transition:transform .12s ease,box-shadow .12s ease;cursor:crosshair;flex:1;min-width:120px}.icon-link[data-astro-cid-zetdm5md]:hover{transform:translate(-2px,-2px);box-shadow:7px 7px 0 var(--black)}.icon-bl[data-astro-cid-zetdm5md]{background:var(--yellow)}.icon-ts[data-astro-cid-zetdm5md]{background:var(--coral)}.icon-dr[data-astro-cid-zetdm5md]{background:var(--cyan)}.icon-hw[data-astro-cid-zetdm5md]{background:var(--orange)}.icon-link[data-astro-cid-zetdm5md] span[data-astro-cid-zetdm5md]{font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.7rem;letter-spacing:.06em;text-transform:uppercase;color:var(--black)}.icon-ts[data-astro-cid-zetdm5md] span[data-astro-cid-zetdm5md]{color:var(--white)}.error-cta-row[data-astro-cid-zetdm5md]{display:flex;align-items:center;gap:16px}.home-cta[data-astro-cid-zetdm5md]{display:inline-flex;align-items:center;gap:8px;font-family:Bricolage Grotesque,sans-serif;font-weight:800;font-size:1rem;letter-spacing:-.01em;text-decoration:none;background:var(--black);color:var(--yellow);padding:14px 28px;border:3px solid var(--black);box-shadow:6px 6px 0 var(--yellow);transition:transform .12s ease,box-shadow .12s ease;cursor:crosshair}.home-cta[data-astro-cid-zetdm5md]:hover{transform:translate(-3px,-3px);box-shadow:9px 9px 0 var(--yellow)}@media(max-width:640px){.error-digits[data-astro-cid-zetdm5md]{margin-bottom:36px}.error-digit[data-astro-cid-zetdm5md]{padding:0 clamp(8px,2vw,14px)}.icon-row[data-astro-cid-zetdm5md]{gap:12px}.icon-link[data-astro-cid-zetdm5md]{min-width:calc(50% - 6px);flex:none;width:calc(50% - 6px)}}\n"},{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/404","isIndex":false,"type":"page","pattern":"^\\/404\\/?$","segments":[[{"content":"404","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/404.astro","pathname":"/404","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/posts/[...slug]","isIndex":false,"type":"page","pattern":"^\\/posts(?:\\/(.*?))?\\/?$","segments":[[{"content":"posts","dynamic":false,"spread":false}],[{"content":"...slug","dynamic":true,"spread":true}]],"params":["...slug"],"component":"src/pages/posts/[...slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".tf-wrapper[data-astro-cid-rhd4iwbo]{margin-bottom:28px}.tf-bar[data-astro-cid-rhd4iwbo]{display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap;margin-bottom:10px}.tf-tags[data-astro-cid-rhd4iwbo]{display:flex;flex-wrap:wrap;gap:7px;flex:1;min-width:0}.tf-tag[data-astro-cid-rhd4iwbo]{font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.68rem;letter-spacing:.06em;text-transform:uppercase;padding:5px 10px;border:2px solid var(--black);background:transparent;color:var(--black);cursor:pointer;transition:transform .1s ease,box-shadow .1s ease;display:inline-flex;align-items:center;gap:5px;line-height:1;white-space:nowrap}.tf-tag[data-astro-cid-rhd4iwbo]:hover{transform:translate(-1px,-1px);box-shadow:2px 2px 0 var(--black)}.tf-tag[data-astro-cid-rhd4iwbo]:active{transform:translate(0);box-shadow:none}[data-astro-cid-rhd4iwbo][data-tf-accent=yellow] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--yellow);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=coral] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--coral);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=cyan] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--cyan);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=orange] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--orange);color:var(--black)}.tf-badge[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.62rem;font-weight:400;background:#0d0d0d1a;padding:1px 5px;letter-spacing:0;text-transform:none}.tf-sort-group[data-astro-cid-rhd4iwbo]{display:flex;border:2px solid var(--black);flex-shrink:0;align-self:flex-start}.tf-sort-btn[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.62rem;letter-spacing:.04em;padding:5px 11px;border:none;background:transparent;color:#0d0d0d73;cursor:pointer;transition:background .12s,color .12s;line-height:1}.tf-sort-btn[data-astro-cid-rhd4iwbo]+.tf-sort-btn[data-astro-cid-rhd4iwbo]{border-left:2px solid var(--black)}.tf-sort-btn[data-astro-cid-rhd4iwbo].is-active{background:var(--black);color:#f5f0e8}.tf-meta[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.68rem;color:#0d0d0d66;margin:0}@media(max-width:640px){.tf-sort-group[data-astro-cid-rhd4iwbo]{display:none}.tf-tag[data-astro-cid-rhd4iwbo]{font-size:.63rem;padding:4px 8px}}\n.bl-hero[data-astro-cid-iybvz6ky]{position:relative;background:var(--yellow);border:4px solid var(--black);box-shadow:10px 10px 0 var(--black);padding:44px 40px 40px;margin:40px 0 52px;display:grid;grid-template-columns:1fr auto;gap:32px;align-items:center;overflow:hidden}.bl-hero[data-astro-cid-iybvz6ky]:before{content:\"\";position:absolute;inset:0;background-image:repeating-linear-gradient(45deg,transparent,transparent 18px,rgba(13,13,13,.04) 18px,rgba(13,13,13,.04) 20px);pointer-events:none}.bl-eyebrow[data-astro-cid-iybvz6ky]{font-family:Space Mono,monospace;font-size:.72rem;letter-spacing:.04em;color:#0d0d0d99;display:block;margin-bottom:10px}.bl-title[data-astro-cid-iybvz6ky]{font-family:Bricolage Grotesque,sans-serif;font-weight:800;font-size:clamp(3.2rem,9vw,6rem);letter-spacing:-.04em;line-height:.88;color:var(--black);margin-bottom:24px}.bl-meta-row[data-astro-cid-iybvz6ky]{display:flex;align-items:center;gap:12px;flex-wrap:wrap}.bl-count-pill[data-astro-cid-iybvz6ky]{font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.75rem;letter-spacing:.05em;text-transform:uppercase;background:var(--black);color:var(--yellow);padding:5px 14px;border:2px solid var(--black)}.bl-latest-label[data-astro-cid-iybvz6ky]{font-family:Space Mono,monospace;font-size:.7rem;color:var(--black);opacity:.65}.bl-icon-wrap[data-astro-cid-iybvz6ky]{display:flex;align-items:center;justify-content:center;transform:rotate(-6deg);filter:drop-shadow(5px 5px 0 rgba(13,13,13,.25));transition:transform .2s ease}.bl-icon-wrap[data-astro-cid-iybvz6ky]:hover{transform:rotate(-2deg) scale(1.04)}.bl-watermark[data-astro-cid-iybvz6ky]{position:absolute;bottom:-12px;right:200px;font-family:Archivo Black,sans-serif;font-size:clamp(6rem,16vw,11rem);line-height:1;color:transparent;-webkit-text-stroke:3px rgba(13,13,13,.09);pointer-events:none;user-select:none;z-index:0}.bl-hero-text[data-astro-cid-iybvz6ky]{position:relative;z-index:1}.posts-section[data-astro-cid-iybvz6ky]{margin-bottom:80px}.posts-section[data-astro-cid-iybvz6ky] .section-label[data-astro-cid-iybvz6ky]{margin-bottom:28px;display:inline-block}.posts-grid[data-astro-cid-iybvz6ky]{margin-top:20px}.load-more-btn[data-astro-cid-iybvz6ky]{display:block;margin:28px auto 0;font-family:Space Mono,monospace;font-size:.72rem;letter-spacing:.06em;padding:10px 24px;border:2px solid var(--black);background:var(--yellow);color:var(--black);cursor:pointer;transition:transform .1s ease,box-shadow .1s ease}.load-more-btn[data-astro-cid-iybvz6ky]:hover{transform:translate(-2px,-2px);box-shadow:4px 4px 0 var(--black)}.load-more-btn[data-astro-cid-iybvz6ky][hidden]{display:none}.empty-state[data-astro-cid-iybvz6ky]{font-family:Space Mono,monospace;font-size:.85rem;color:#0d0d0d80;margin-top:24px;padding:32px;border:2px dashed rgba(13,13,13,.2);text-align:center}.scroll-reveal[data-astro-cid-iybvz6ky]{opacity:0;transform:translateY(24px);transition:opacity .55s cubic-bezier(.4,0,.2,1),transform .55s cubic-bezier(.4,0,.2,1)}.scroll-reveal[data-astro-cid-iybvz6ky].is-visible{opacity:1;transform:none}.posts-section[data-astro-cid-iybvz6ky].scroll-reveal{transition-delay:.1s}@media(max-width:640px){.bl-hero[data-astro-cid-iybvz6ky]{grid-template-columns:1fr;padding:32px 24px;margin:24px 0 40px}.bl-icon-wrap[data-astro-cid-iybvz6ky]{display:none}.bl-watermark[data-astro-cid-iybvz6ky]{right:16px}.bl-title[data-astro-cid-iybvz6ky]{font-size:clamp(2.8rem,14vw,4rem)}}\n"},{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/writing/build-log","isIndex":true,"type":"page","pattern":"^\\/writing\\/build-log\\/?$","segments":[[{"content":"writing","dynamic":false,"spread":false}],[{"content":"build-log","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/writing/build-log/index.astro","pathname":"/writing/build-log","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".tf-wrapper[data-astro-cid-rhd4iwbo]{margin-bottom:28px}.tf-bar[data-astro-cid-rhd4iwbo]{display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap;margin-bottom:10px}.tf-tags[data-astro-cid-rhd4iwbo]{display:flex;flex-wrap:wrap;gap:7px;flex:1;min-width:0}.tf-tag[data-astro-cid-rhd4iwbo]{font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.68rem;letter-spacing:.06em;text-transform:uppercase;padding:5px 10px;border:2px solid var(--black);background:transparent;color:var(--black);cursor:pointer;transition:transform .1s ease,box-shadow .1s ease;display:inline-flex;align-items:center;gap:5px;line-height:1;white-space:nowrap}.tf-tag[data-astro-cid-rhd4iwbo]:hover{transform:translate(-1px,-1px);box-shadow:2px 2px 0 var(--black)}.tf-tag[data-astro-cid-rhd4iwbo]:active{transform:translate(0);box-shadow:none}[data-astro-cid-rhd4iwbo][data-tf-accent=yellow] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--yellow);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=coral] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--coral);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=cyan] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--cyan);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=orange] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--orange);color:var(--black)}.tf-badge[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.62rem;font-weight:400;background:#0d0d0d1a;padding:1px 5px;letter-spacing:0;text-transform:none}.tf-sort-group[data-astro-cid-rhd4iwbo]{display:flex;border:2px solid var(--black);flex-shrink:0;align-self:flex-start}.tf-sort-btn[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.62rem;letter-spacing:.04em;padding:5px 11px;border:none;background:transparent;color:#0d0d0d73;cursor:pointer;transition:background .12s,color .12s;line-height:1}.tf-sort-btn[data-astro-cid-rhd4iwbo]+.tf-sort-btn[data-astro-cid-rhd4iwbo]{border-left:2px solid var(--black)}.tf-sort-btn[data-astro-cid-rhd4iwbo].is-active{background:var(--black);color:#f5f0e8}.tf-meta[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.68rem;color:#0d0d0d66;margin:0}@media(max-width:640px){.tf-sort-group[data-astro-cid-rhd4iwbo]{display:none}.tf-tag[data-astro-cid-rhd4iwbo]{font-size:.63rem;padding:4px 8px}}\n.dr-hero[data-astro-cid-sebmm45s]{position:relative;background:var(--white);border-top:4px solid var(--black);border-right:4px solid var(--black);border-bottom:4px solid var(--black);border-left:8px solid var(--cyan);box-shadow:10px 10px 0 var(--black);padding:44px 40px 44px 36px;margin:40px 0 52px;display:grid;grid-template-columns:1fr auto;gap:40px;align-items:center;overflow:hidden}.dr-series-pill[data-astro-cid-sebmm45s]{display:inline-block;font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.7rem;letter-spacing:.08em;text-transform:uppercase;background:var(--cyan);color:var(--black);border:2px solid var(--black);padding:4px 14px;margin-bottom:16px}.dr-title[data-astro-cid-sebmm45s]{font-family:Bricolage Grotesque,sans-serif;font-weight:800;font-size:clamp(3rem,9vw,5.5rem);letter-spacing:-.04em;line-height:.88;color:var(--black);margin-bottom:14px}.dr-tagline[data-astro-cid-sebmm45s]{font-family:Space Mono,monospace;font-size:.78rem;color:#0d0d0d8c;margin-bottom:24px;letter-spacing:.02em}.dr-pips[data-astro-cid-sebmm45s]{display:flex;gap:6px;flex-wrap:wrap}.dr-pip[data-astro-cid-sebmm45s]{width:14px;height:14px;background:#0d0d0d1f;border:2px solid rgba(13,13,13,.2)}.dr-pip--filled[data-astro-cid-sebmm45s]{background:var(--black);border-color:var(--black)}.dr-pip--current[data-astro-cid-sebmm45s]{background:var(--cyan);border-color:var(--black);box-shadow:2px 2px 0 var(--black)}.dr-icon-wrap[data-astro-cid-sebmm45s]{display:flex;align-items:center;justify-content:center;transform:rotate(4deg) translateY(-8px);filter:drop-shadow(5px 5px 0 rgba(13,13,13,.2));transition:transform .2s ease}.dr-icon-wrap[data-astro-cid-sebmm45s]:hover{transform:rotate(1deg) translateY(-4px) scale(1.04)}.posts-section[data-astro-cid-sebmm45s]{margin-bottom:80px}.posts-section[data-astro-cid-sebmm45s] .section-label[data-astro-cid-sebmm45s]{margin-bottom:28px;display:inline-block}.posts-grid[data-astro-cid-sebmm45s]{margin-top:20px}.load-more-btn[data-astro-cid-sebmm45s]{display:block;margin:28px auto 0;font-family:Space Mono,monospace;font-size:.72rem;letter-spacing:.06em;padding:10px 24px;border:2px solid var(--black);background:var(--cyan);color:var(--black);cursor:pointer;transition:transform .1s ease,box-shadow .1s ease}.load-more-btn[data-astro-cid-sebmm45s]:hover{transform:translate(-2px,-2px);box-shadow:4px 4px 0 var(--black)}.load-more-btn[data-astro-cid-sebmm45s][hidden]{display:none}.empty-state[data-astro-cid-sebmm45s]{font-family:Space Mono,monospace;font-size:.85rem;color:#0d0d0d80;margin-top:24px;padding:32px;border:2px dashed rgba(13,13,13,.2);text-align:center}.scroll-reveal[data-astro-cid-sebmm45s]{opacity:0;transform:translateY(24px);transition:opacity .55s cubic-bezier(.4,0,.2,1),transform .55s cubic-bezier(.4,0,.2,1)}.scroll-reveal[data-astro-cid-sebmm45s].is-visible{opacity:1;transform:none}.posts-section[data-astro-cid-sebmm45s].scroll-reveal{transition-delay:.1s}@media(max-width:640px){.dr-hero[data-astro-cid-sebmm45s]{grid-template-columns:1fr;padding:32px 24px 32px 20px;margin:24px 0 40px}.dr-icon-wrap[data-astro-cid-sebmm45s]{display:none}.dr-title[data-astro-cid-sebmm45s]{font-size:clamp(2.8rem,14vw,4rem)}}\n"},{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/writing/dev-return","isIndex":true,"type":"page","pattern":"^\\/writing\\/dev-return\\/?$","segments":[[{"content":"writing","dynamic":false,"spread":false}],[{"content":"dev-return","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/writing/dev-return/index.astro","pathname":"/writing/dev-return","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".hw-hero[data-astro-cid-7uu5jng5]{position:relative;background:var(--orange);border:4px solid var(--black);box-shadow:10px 10px 0 var(--black);padding:48px 40px;margin:40px 0 52px;display:grid;grid-template-columns:1fr auto;gap:40px;align-items:center;overflow:hidden}.hw-hero[data-astro-cid-7uu5jng5]:after{content:\"\";position:absolute;bottom:-30px;right:-30px;width:110px;height:110px;background:var(--yellow);border:3px solid var(--black);transform:rotate(18deg);opacity:.5;pointer-events:none;z-index:0}.hw-lesson-label[data-astro-cid-7uu5jng5]{display:inline-block;font-family:Space Mono,monospace;font-size:.7rem;letter-spacing:.1em;text-transform:uppercase;background:var(--black);color:var(--orange);padding:4px 12px;margin-bottom:16px}.hw-title[data-astro-cid-7uu5jng5]{font-family:Bricolage Grotesque,sans-serif;font-weight:800;font-size:clamp(3rem,9vw,5.5rem);letter-spacing:-.04em;line-height:.88;color:var(--black);margin-bottom:14px}.hw-tagline[data-astro-cid-7uu5jng5]{font-family:Space Mono,monospace;font-size:.78rem;color:#0d0d0d99;margin-bottom:20px;letter-spacing:.02em}.hw-count-pill[data-astro-cid-7uu5jng5]{display:inline-block;font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.75rem;letter-spacing:.05em;text-transform:uppercase;background:var(--black);color:var(--orange);padding:5px 14px;border:2px solid var(--black)}.hw-hero-text[data-astro-cid-7uu5jng5]{position:relative;z-index:1}.hw-icon-wrap[data-astro-cid-7uu5jng5]{display:flex;align-items:center;justify-content:center;transform:rotate(6deg);filter:drop-shadow(5px 5px 0 rgba(13,13,13,.3));transition:transform .2s ease;position:relative;z-index:1}.hw-icon-wrap[data-astro-cid-7uu5jng5]:hover{transform:rotate(2deg) scale(1.04)}.hw-slabs[data-astro-cid-7uu5jng5]{position:absolute;top:0;right:220px;bottom:0;display:flex;align-items:flex-end;gap:5px;padding-bottom:0;opacity:.1;pointer-events:none;z-index:0}.hw-slab[data-astro-cid-7uu5jng5]{width:14px;background:var(--black);align-self:flex-end}.hw-watermark[data-astro-cid-7uu5jng5]{position:absolute;bottom:-20px;left:28px;font-family:Archivo Black,sans-serif;font-size:clamp(6rem,16vw,10rem);line-height:1;color:transparent;-webkit-text-stroke:3px rgba(13,13,13,.1);pointer-events:none;user-select:none;z-index:0}.posts-section[data-astro-cid-7uu5jng5]{margin-bottom:80px}.posts-section[data-astro-cid-7uu5jng5] .section-label[data-astro-cid-7uu5jng5]{margin-bottom:28px;display:inline-block}.posts-grid[data-astro-cid-7uu5jng5]{margin-top:20px}.empty-state[data-astro-cid-7uu5jng5]{font-family:Space Mono,monospace;font-size:.85rem;color:#0d0d0d80;margin-top:24px;padding:32px;border:2px dashed rgba(13,13,13,.2);text-align:center}.scroll-reveal[data-astro-cid-7uu5jng5]{opacity:0;transform:translateY(24px);transition:opacity .55s cubic-bezier(.4,0,.2,1),transform .55s cubic-bezier(.4,0,.2,1)}.scroll-reveal[data-astro-cid-7uu5jng5].is-visible{opacity:1;transform:none}.posts-section[data-astro-cid-7uu5jng5].scroll-reveal{transition-delay:.1s}@media(max-width:640px){.hw-hero[data-astro-cid-7uu5jng5]{grid-template-columns:1fr;padding:32px 24px;margin:24px 0 40px}.hw-icon-wrap[data-astro-cid-7uu5jng5],.hw-slabs[data-astro-cid-7uu5jng5]{display:none}.hw-watermark[data-astro-cid-7uu5jng5]{left:12px}.hw-title[data-astro-cid-7uu5jng5]{font-size:clamp(2.8rem,14vw,4rem)}}\n"},{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/writing/hard-won","isIndex":true,"type":"page","pattern":"^\\/writing\\/hard-won\\/?$","segments":[[{"content":"writing","dynamic":false,"spread":false}],[{"content":"hard-won","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/writing/hard-won/index.astro","pathname":"/writing/hard-won","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".tf-wrapper[data-astro-cid-rhd4iwbo]{margin-bottom:28px}.tf-bar[data-astro-cid-rhd4iwbo]{display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap;margin-bottom:10px}.tf-tags[data-astro-cid-rhd4iwbo]{display:flex;flex-wrap:wrap;gap:7px;flex:1;min-width:0}.tf-tag[data-astro-cid-rhd4iwbo]{font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.68rem;letter-spacing:.06em;text-transform:uppercase;padding:5px 10px;border:2px solid var(--black);background:transparent;color:var(--black);cursor:pointer;transition:transform .1s ease,box-shadow .1s ease;display:inline-flex;align-items:center;gap:5px;line-height:1;white-space:nowrap}.tf-tag[data-astro-cid-rhd4iwbo]:hover{transform:translate(-1px,-1px);box-shadow:2px 2px 0 var(--black)}.tf-tag[data-astro-cid-rhd4iwbo]:active{transform:translate(0);box-shadow:none}[data-astro-cid-rhd4iwbo][data-tf-accent=yellow] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--yellow);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=coral] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--coral);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=cyan] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--cyan);color:var(--black)}[data-astro-cid-rhd4iwbo][data-tf-accent=orange] .tf-tag[data-astro-cid-rhd4iwbo].is-active{background:var(--orange);color:var(--black)}.tf-badge[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.62rem;font-weight:400;background:#0d0d0d1a;padding:1px 5px;letter-spacing:0;text-transform:none}.tf-sort-group[data-astro-cid-rhd4iwbo]{display:flex;border:2px solid var(--black);flex-shrink:0;align-self:flex-start}.tf-sort-btn[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.62rem;letter-spacing:.04em;padding:5px 11px;border:none;background:transparent;color:#0d0d0d73;cursor:pointer;transition:background .12s,color .12s;line-height:1}.tf-sort-btn[data-astro-cid-rhd4iwbo]+.tf-sort-btn[data-astro-cid-rhd4iwbo]{border-left:2px solid var(--black)}.tf-sort-btn[data-astro-cid-rhd4iwbo].is-active{background:var(--black);color:#f5f0e8}.tf-meta[data-astro-cid-rhd4iwbo]{font-family:Space Mono,monospace;font-size:.68rem;color:#0d0d0d66;margin:0}@media(max-width:640px){.tf-sort-group[data-astro-cid-rhd4iwbo]{display:none}.tf-tag[data-astro-cid-rhd4iwbo]{font-size:.63rem;padding:4px 8px}}\n.ts-hero[data-astro-cid-vyk3nnc5]{position:relative;background:var(--black);border:4px solid var(--coral);box-shadow:10px 10px 0 var(--coral);padding:52px 44px;margin:40px 0 52px;display:grid;grid-template-columns:1fr auto;gap:40px;align-items:center;overflow:hidden;color:var(--white)}.ts-count-pill[data-astro-cid-vyk3nnc5]{display:inline-block;font-family:Space Grotesk,sans-serif;font-weight:700;font-size:.7rem;letter-spacing:.08em;text-transform:uppercase;background:var(--coral);color:var(--black);border:2px solid var(--coral);padding:4px 14px;margin-bottom:16px}.ts-title[data-astro-cid-vyk3nnc5]{font-family:Bricolage Grotesque,sans-serif;font-weight:800;font-size:clamp(3rem,9vw,5.5rem);letter-spacing:-.04em;line-height:.88;color:var(--white);margin-bottom:16px}.ts-tagline[data-astro-cid-vyk3nnc5]{font-family:Lora,serif;font-style:italic;font-size:1.05rem;color:#f5f0e8a6;margin:0}.ts-icon-wrap[data-astro-cid-vyk3nnc5]{display:flex;align-items:center;justify-content:center;border:3px solid var(--coral);box-shadow:8px 8px 0 var(--coral);transition:transform .2s ease,box-shadow .2s ease;flex-shrink:0}.ts-icon-wrap[data-astro-cid-vyk3nnc5]:hover{transform:translate(-2px,-2px);box-shadow:10px 10px 0 var(--coral)}.ts-deco-circle[data-astro-cid-vyk3nnc5]{position:absolute;top:-50px;right:-60px;width:240px;height:240px;border:36px solid var(--coral);border-radius:50%;opacity:.1;pointer-events:none;z-index:0}.ts-hero-text[data-astro-cid-vyk3nnc5]{position:relative;z-index:1}.ts-section-label[data-astro-cid-vyk3nnc5]{background:var(--coral)!important;color:var(--black)!important}.posts-section[data-astro-cid-vyk3nnc5]{margin-bottom:80px}.posts-section[data-astro-cid-vyk3nnc5] .section-label[data-astro-cid-vyk3nnc5]{margin-bottom:28px;display:inline-block}.posts-grid[data-astro-cid-vyk3nnc5]{margin-top:20px}.load-more-btn[data-astro-cid-vyk3nnc5]{display:block;margin:28px auto 0;font-family:Space Mono,monospace;font-size:.72rem;letter-spacing:.06em;padding:10px 24px;border:2px solid var(--coral);background:var(--black);color:var(--coral);cursor:pointer;transition:transform .1s ease,box-shadow .1s ease}.load-more-btn[data-astro-cid-vyk3nnc5]:hover{transform:translate(-2px,-2px);box-shadow:4px 4px 0 var(--coral)}.load-more-btn[data-astro-cid-vyk3nnc5][hidden]{display:none}.empty-state[data-astro-cid-vyk3nnc5]{font-family:Space Mono,monospace;font-size:.85rem;color:#0d0d0d80;margin-top:24px;padding:32px;border:2px dashed rgba(13,13,13,.2);text-align:center}.scroll-reveal[data-astro-cid-vyk3nnc5]{opacity:0;transform:translateY(24px);transition:opacity .55s cubic-bezier(.4,0,.2,1),transform .55s cubic-bezier(.4,0,.2,1)}.scroll-reveal[data-astro-cid-vyk3nnc5].is-visible{opacity:1;transform:none}.posts-section[data-astro-cid-vyk3nnc5].scroll-reveal{transition-delay:.1s}@media(max-width:640px){.ts-hero[data-astro-cid-vyk3nnc5]{grid-template-columns:1fr;padding:36px 24px;margin:24px 0 40px}.ts-icon-wrap[data-astro-cid-vyk3nnc5]{display:none}.ts-deco-circle[data-astro-cid-vyk3nnc5]{width:160px;height:160px;right:-40px;top:-30px}.ts-title[data-astro-cid-vyk3nnc5]{font-size:clamp(2.8rem,14vw,4rem)}}\n"},{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/writing/the-search","isIndex":true,"type":"page","pattern":"^\\/writing\\/the-search\\/?$","segments":[[{"content":"writing","dynamic":false,"spread":false}],[{"content":"the-search","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/writing/the-search/index.astro","pathname":"/writing/the-search","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.DsFekiHL.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":true,"experimentalQueuedRendering":{"enabled":false,"poolSize":0,"contentCache":false},"componentMetadata":[["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/posts/[...slug].astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/404.astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/index.astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/build-log/index.astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/dev-return/index.astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/hard-won/index.astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/the-search/index.astro",{"propagation":"in-tree","containsHead":true}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/layouts/BaseLayout.astro",{"propagation":"in-tree","containsHead":false}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/layouts/PostLayout.astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/posts/[...slug]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:pages",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:manifest",{"propagation":"in-tree","containsHead":false}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/node_modules/astro/dist/core/app/entrypoints/virtual/prod.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:app",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/404@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/writing/build-log/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/writing/dev-return/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/writing/hard-won/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/writing/the-search/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000astro:content",{"propagation":"in-tree","containsHead":false}],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/components/Nav.astro",{"propagation":"in-tree","containsHead":false}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_DsBX4kaI.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_Csu6PJY6.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_CFl7y3Qj.mjs","\u0000virtual:astro:page:src/pages/404@_@astro":"chunks/404_B_xK22rV.mjs","\u0000virtual:astro:page:src/pages/posts/[...slug]@_@astro":"chunks/_.._CwOhQQyN.mjs","\u0000virtual:astro:page:src/pages/writing/build-log/index@_@astro":"chunks/index_B1ItXxXr.mjs","\u0000virtual:astro:page:src/pages/writing/dev-return/index@_@astro":"chunks/index_DyS1Z4up.mjs","\u0000virtual:astro:page:src/pages/writing/hard-won/index@_@astro":"chunks/index_CPYstlNy.mjs","\u0000virtual:astro:page:src/pages/writing/the-search/index@_@astro":"chunks/index_BRinAai5.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_BLegWg6Y.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/.astro/content-assets.mjs":"chunks/content-assets_CL5hQMHo.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/.astro/content-modules.mjs":"chunks/content-modules_DwK-iyqO.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_DTLRpRSH.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/node_modules/@astrojs/cloudflare/dist/entrypoints/image-service-workerd.js":"chunks/image-service-workerd_DVXnE0iJ.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/build-log-04.mdx?astroPropagatedAssets":"chunks/build-log-04_BTPg2fPy.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/dev-return-03.mdx?astroPropagatedAssets":"chunks/dev-return-03_CH1HqWcO.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/hard-won-02.mdx?astroPropagatedAssets":"chunks/hard-won-02_lmYLINCC.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/the-search-week-03.mdx?astroPropagatedAssets":"chunks/the-search-week-03_BR0h8wj6.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/build-log-04.mdx":"chunks/build-log-04_Cd5TT1fd.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/dev-return-03.mdx":"chunks/dev-return-03_Hzd4-qM-.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/hard-won-02.mdx":"chunks/hard-won-02_BYC0hL5r.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/content/posts/the-search-week-03.mdx":"chunks/the-search-week-03_BlprApDW.mjs","virtual:cloudflare/worker-entry":"entry.mjs","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/build-log/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.BwtoN3Pb.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/dev-return/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.CWa5COte.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/hard-won/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.C5wYUpTX.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/the-search/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.C2BfRxDT.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.DDr455RN.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/components/TagFilter.astro?astro&type=script&index=0&lang.ts":"_astro/TagFilter.astro_astro_type_script_index_0_lang.9oTKlUQq.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/components/Nav.astro?astro&type=script&index=0&lang.ts":"_astro/Nav.astro_astro_type_script_index_0_lang.C6gM5HaC.js","/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts":"_astro/ClientRouter.astro_astro_type_script_index_0_lang.BcdOYiQn.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/build-log/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.addEventListener(\"astro:page-load\",()=>{const i=document.querySelectorAll(\".scroll-reveal\");if(\"IntersectionObserver\"in window){const e=new IntersectionObserver(s=>{s.forEach(r=>{r.isIntersecting&&(r.target.classList.add(\"is-visible\"),e.unobserve(r.target))})},{threshold:.12});i.forEach(s=>{s.classList.remove(\"is-visible\"),e.observe(s)})}else i.forEach(e=>e.classList.add(\"is-visible\"))});"],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/dev-return/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.addEventListener(\"astro:page-load\",()=>{const i=document.querySelectorAll(\".scroll-reveal\");if(\"IntersectionObserver\"in window){const e=new IntersectionObserver(s=>{s.forEach(r=>{r.isIntersecting&&(r.target.classList.add(\"is-visible\"),e.unobserve(r.target))})},{threshold:.12});i.forEach(s=>{s.classList.remove(\"is-visible\"),e.observe(s)})}else i.forEach(e=>e.classList.add(\"is-visible\"))});"],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/hard-won/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.addEventListener(\"astro:page-load\",()=>{const i=document.querySelectorAll(\".scroll-reveal\");if(\"IntersectionObserver\"in window){const e=new IntersectionObserver(s=>{s.forEach(r=>{r.isIntersecting&&(r.target.classList.add(\"is-visible\"),e.unobserve(r.target))})},{threshold:.12});i.forEach(s=>{s.classList.remove(\"is-visible\"),e.observe(s)})}else i.forEach(e=>e.classList.add(\"is-visible\"))});"],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/writing/the-search/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.addEventListener(\"astro:page-load\",()=>{const i=document.querySelectorAll(\".scroll-reveal\");if(\"IntersectionObserver\"in window){const e=new IntersectionObserver(s=>{s.forEach(r=>{r.isIntersecting&&(r.target.classList.add(\"is-visible\"),e.unobserve(r.target))})},{threshold:.12});i.forEach(s=>{s.classList.remove(\"is-visible\"),e.observe(s)})}else i.forEach(e=>e.classList.add(\"is-visible\"))});"],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/pages/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.addEventListener(\"astro:page-load\",()=>{const i=document.querySelectorAll(\".scroll-reveal\");if(\"IntersectionObserver\"in window){const e=new IntersectionObserver(s=>{s.forEach(r=>{r.isIntersecting&&(r.target.classList.add(\"is-visible\"),e.unobserve(r.target))})},{threshold:.15});i.forEach(s=>{s.classList.remove(\"is-visible\"),e.observe(s)})}else i.forEach(e=>e.classList.add(\"is-visible\"))});"],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/components/TagFilter.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.addEventListener(\"astro:page-load\",()=>{document.querySelectorAll(\".tf-wrapper\").forEach(s=>{const f=s.closest(\"section\");if(!f)return;const h=f.querySelector(\"[data-posts-grid]\"),c=f.querySelector(\"[data-load-more]\");if(!h)return;const l=parseInt(s.dataset.defaultLimit??\"8\");let o=\"\",n=\"newest\",g=l;const m=new URLSearchParams(window.location.search);o=m.get(\"tag\")??\"\",n=m.get(\"sort\")??\"newest\";function v(){return[...h.querySelectorAll(\"[data-post-item]\")]}function w(){const e=new URLSearchParams;o&&e.set(\"tag\",o),n!==\"newest\"&&e.set(\"sort\",n);const a=e.toString();history.replaceState(null,\"\",a?`?${a}`:window.location.pathname)}function i(){const e=v(),a=o?e.filter(t=>(t.dataset.tags??\"\").split(\",\").map(u=>u.trim()).includes(o)):e,d=[...a].sort((t,r)=>{const u=parseInt(t.dataset.date??\"0\"),q=parseInt(r.dataset.date??\"0\");return n===\"newest\"?q-u:u-q}),S=!o,E=S?d.slice(0,g):d;e.forEach(t=>{t.hidden=!0,t.style.order=\"\"}),d.forEach((t,r)=>{t.style.order=String(r)}),E.forEach(t=>{t.hidden=!1});const y=s.querySelector(\".tf-result-count\"),L=s.querySelector(\".tf-result-word\");if(y&&(y.textContent=String(a.length)),L&&(L.textContent=a.length===1?\"post\":\"posts\"),c){const t=d.length-E.length;if(S&&t>0){c.hidden=!1;const r=Math.min(t,l);c.textContent=`Show ${r} more →`}else c.hidden=!0}s.querySelectorAll(\".tf-tag\").forEach(t=>{t.classList.toggle(\"is-active\",t.dataset.tag===o)}),s.querySelectorAll(\".tf-sort-btn\").forEach(t=>{t.classList.toggle(\"is-active\",t.dataset.sort===n)}),w()}s.querySelectorAll(\".tf-tag\").forEach(e=>{e.addEventListener(\"click\",()=>{o=e.dataset.tag??\"\",g=l,i()})}),s.querySelectorAll(\".tf-sort-btn\").forEach(e=>{e.addEventListener(\"click\",()=>{n=e.dataset.sort??\"newest\",i()})}),c?.addEventListener(\"click\",()=>{g+=l,i()}),i()})});"],["/Users/bbeltowski/Documents/Dev_Box/demos/portfolio/src/components/Nav.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};function u(){const i=document.querySelectorAll(\".has-mega, .has-dropdown\");i.forEach(e=>{const s=e.querySelector(\".nav-trigger\"),t=e.querySelector(\".mega-panel, .dropdown-panel\");if(!s)return;let n=null;function a(){n&&(clearTimeout(n),n=null),e.classList.add(\"is-open\"),s.setAttribute(\"aria-expanded\",\"true\")}function l(){e.classList.contains(\"is-pinned\")||(n&&clearTimeout(n),n=setTimeout(()=>{e.classList.remove(\"is-open\"),s.setAttribute(\"aria-expanded\",\"false\"),n=null},180))}function d(){n&&(clearTimeout(n),n=null),e.classList.remove(\"is-open\",\"is-pinned\"),s.setAttribute(\"aria-expanded\",\"false\")}e.addEventListener(\"mouseenter\",()=>{e.classList.contains(\"is-pinned\")||a()}),e.addEventListener(\"mouseleave\",l),t&&(t.addEventListener(\"mouseenter\",()=>{e.classList.contains(\"is-pinned\")||a()}),t.addEventListener(\"mouseleave\",l)),s.addEventListener(\"click\",r=>{r.preventDefault();const c=e.classList.contains(\"is-pinned\");i.forEach(o=>{o!==e&&(o.classList.remove(\"is-pinned\",\"is-open\"),o.querySelector(\".nav-trigger\")?.setAttribute(\"aria-expanded\",\"false\"))}),c?d():(e.classList.add(\"is-pinned\"),a())}),e.addEventListener(\"keydown\",r=>{r.key===\"Escape\"&&(d(),s.focus())})}),document.addEventListener(\"click\",e=>{i.forEach(s=>{s.contains(e.target)||(s.classList.remove(\"is-pinned\",\"is-open\"),s.querySelector(\".nav-trigger\")?.setAttribute(\"aria-expanded\",\"false\"))})})}document.addEventListener(\"astro:page-load\",u);"]],"assets":["/favicon.svg","/_astro/ClientRouter.astro_astro_type_script_index_0_lang.BcdOYiQn.js","/_astro/AI-Profile-Picture.BjUZmrrc.png","/_astro/BaseLayout.DsFekiHL.css","/404.html","/writing/build-log/index.html","/writing/dev-return/index.html","/writing/hard-won/index.html","/writing/the-search/index.html","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"tmZXyckpA1ckuTb+1GHxST2GxQUh8rfu0fy6Fw6q5/I=","sessionConfig":{"driver":"unstorage/drivers/cloudflare-kv-binding","options":{"binding":"SESSION"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
